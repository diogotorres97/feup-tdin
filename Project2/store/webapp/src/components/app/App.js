          ...
          <div className="top-section">
            ...
            >
              ...
              <GridList cellHeight={260} className="gridList">
                  <GridListTile key="Subheader" cols={this.state.orders.length > 1 ? 2 : 1} style={{ height: 'auto' }}>
              ...
              <Link className="link" to="/createorder"><span className="link-create-order">Create Order</span></Link>
            </Grid>
